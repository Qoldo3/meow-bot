/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c2fcaf20001c1a02ea659ec6600e51aa)
// Runtime types generated with workerd@1.20260722.1 2026-03-10 
interface __BaseEnv_Env {
	DB: D1Database;
	MEOW_VIP_USER_ID: "";
	HOKM_JOIN_TIMEOUT_SEC: 300;
	HOKM_TURN_TIMEOUT_SEC: 60;
	HOKM_TRUMP_TIMEOUT_SEC: 30;
	HOKM_RECONNECT_GRACE_SEC: 90;
	HOKM_AFK_STRIKES: 2;
	HOKM_GAME: DurableObjectNamespace<import("./src/index").HokmGame>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "HokmGame";
	}
